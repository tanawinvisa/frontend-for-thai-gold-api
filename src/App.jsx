...
function App() {
  ...
  const BASE_URL = "https://thai-gold-api-node-express.onrender.com/api/price";
        ...
        <div className="sidebar" id="sidebar">
          <div className="detail">
            ...
            <table>
              <tr>
                <td>ขายออก</td>
                <td className="price" id="gold_bar_buy">
                  {goldPrice.buy}
                </td>
              </tr>
              <tr>
                <td>รับซื้อ</td>
                <td className="price" id="gold_bar_sell">
                  {goldPrice.sell}
                </td>
              </tr>
            </table>
          ...
          <div>
            <h4>
              ข้อมูลล่าสุด ณ วันที่ <span id="date">{date}</span>{" "}
              <span id="update_time">{updateTime}</span>
            </h4>
          </div>
        </div>
